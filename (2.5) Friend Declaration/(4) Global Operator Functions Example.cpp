...
public:
	...
	friend bool operator<(const complex_number& num1, const complex_number& num2);
};
...
bool operator<(const complex_number& num1, const complex_number& num2) {
...
int main() {
	...
	complex_number c1{ 6.0,6.0 };
	complex_number c2{ 5.0,7.0 };
